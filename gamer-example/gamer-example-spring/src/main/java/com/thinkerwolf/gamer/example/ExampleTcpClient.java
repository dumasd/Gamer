...
public class ExampleTcpClient {
    ...
    private static void tcpRequest() {
        ...
        NettyClient nettyClient = new NettyClient(url, new ChannelHandlerAdapter() {
            ...
            public void received(Channel channel, Object message) throws RemotingException {
                ...
                System.err.println("Received " + new String(packet.getContent(), UTF_8));
            }
        });
    ...
    private static void httpRequest() {
        ...
        DefaultFullHttpRequest request = new DefaultFullHttpRequest(HttpVersion.HTTP_1_1, HttpMethod.GET, "/hello/api", Unpooled.EMPTY_BUFFER);
