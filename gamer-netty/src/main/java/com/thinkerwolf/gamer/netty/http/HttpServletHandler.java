...
public class HttpServletHandler extends AbstractServletHandler {
    ...
    public void received(Channel channel, Object message) throws RemotingException {
        ...
        final Response response = new com.thinkerwolf.gamer.netty.http.HttpResponse(nettyChannel, nettyRequest);
        boolean compress = ServletUtil.isCompress(getServletConfig());
        final Request request = new com.thinkerwolf.gamer.netty.http.HttpRequest(nettyChannel, getServletConfig().getServletContext(), nettyRequest, response, compress);
